...
function Query (criteria, options) {
  ...
  var thunk = function(cb) {
    if(cb) thunk.exec.call(thunk,cb);
  };

  thunk.__proto__ = this.__proto__;
  if(!thunk.call) {
    thunk.__proto__.__proto__ = Object.create(Function.prototype);
  }


  thunk.op = proto.op || undefined;

  thunk.options = {};
  thunk.setOptions(proto.options);

  thunk._conditions = proto._conditions
    ? utils.clone(proto._conditions)
    : {};

  thunk._fields = proto._fields
    ? utils.clone(proto._fields)
    : undefined;

  thunk._update = proto._update
    ? utils.clone(proto._update)
    : undefined;

  thunk._path = proto._path || undefined;
  thunk._distinct = proto._distinct || undefined;
  thunk._collection = proto._collection || undefined;

  if (options) {
    thunk.setOptions(options);
  }

  if (criteria) {
    if (criteria.find && criteria.remove && criteria.update) {
      // quack quack!
      thunk.collection(criteria);
    } else {
      thunk.find(criteria);
    }
  }
...
Query.__proto__ = Object.create(Function.prototype);
...
Query.prototype.toConstructor = function toConstructor () {
  function CustomQuery (criteria, options) {
    ...
    debugger;
    return Query.call(this, criteria, options);
  }
...
Query.prototype.where = function () {
  ...
  if (('object' == type && !Array.isArray(arguments[0])) || arguments[0] instanceof Query) {
...
Query.prototype.find = function (criteria, callback) {
  ...
  if ('function' === typeof criteria && !(criteria instanceof Query)) {
    callback = criteria;
    criteria = undefined;
...
Query.prototype.update = function update (criteria, doc, options, callback) {
  ...
  switch (arguments.length) {
    case 3:
      if ('function' == typeof options && !(options instanceof Query)) {
        callback = options;
        options = undefined;
      }
      break;
    case 2:
      if ('function' == typeof doc && !(doc instanceof Query)) {
        callback = doc;
        doc = criteria;
        criteria = undefined;
      }
...
Query.prototype.findOneAndRemove = function (conditions, options, callback) {
  ...
  if ('function' == typeof options && !(options instanceof Query)) {
    callback = options;
    options = undefined;
  } else if ('function' == typeof conditions && !(conditions instanceof Query)) {
    callback = conditions;
