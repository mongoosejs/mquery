...
Query.prototype._findAndModify = function (type, callback) {
  ...
  // the node driver requires a default ?? TODO
  sort = opts.sort || [];

  debug('findAndModify', conds, sort, doc, opts);

  this._collection
  .findAndModify(conds, sort, doc, opts, utils.tick(callback));
}
...
Query.prototype._updateForExec = function () {
  var ops = Object.keys(this._update)
    , i = ops.length
    , ret = {}
    , hasKeys
    , val
