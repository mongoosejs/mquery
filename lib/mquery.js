...
class Query {
  ...
  toConstructor() {
    ...
    return new Proxy(CustomQuery, withoutNew);
  }
   ...
   * @api public
   */
  distinct(criteria, field, callback) {
    this.op = 'distinct';
    this._validate();
   ...
   * @api public
   */
  updateMany(criteria, doc, options, callback) {
    let force;
   ...
   * @api public
   */
  updateOne(criteria, doc, options, callback) {
    let force;
   ...
   * @api public
   */
  replaceOne(criteria, doc, options, callback) {
    let force;
   ...
   *
   * @param {Object} traceFunction
   */
  static setGlobalTraceFunction(traceFunction) {
 ...
 * @api public
 */
Query.prototype.maxTime = Query.prototype.maxTimeMS;
 ...
 * @api public
 */
Query.prototype.read = Query.prototype.setReadPreference;
...
Query.prototype.readConcern = Query.prototype.r;
 ...
 * @api public
 */
Query.prototype.writeConcern = Query.prototype.w;
 ...
 * @api public
 */
Query.prototype.findOneAndRemove = Query.prototype.findOneAndDelete;
